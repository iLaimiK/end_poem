...
const ShiroAbilities = ['存在即法则', '全知', '概念消除', '泡泡空间'] as const;
...
export const Schema = z.object({
  ...
  主要角色: z
    .object({
      白: z
        .object({
          身份: uniqueStrArrayWith(['外神'], ['外神']),
          关注度: clampedNum(0.01, 0, 1),
          外观: z
            .object({
              外貌: appearance({
          ...
          能力: z
            ...
            .transform(locked([...ShiroAbilities])),
        })
        .prefault({}),

      澪: z
        .object({
          身份: uniqueStrArray(['失踪人员', '拾荒者']),
          好感度: clampedNum(0.01, -1, 1),
          治愈进度: clampedNum(0, 0, 90),
          ...
          能力: z
            .object({
              ...
              法则预判: lockedStr('在完全解析一条法则后，能够预判出该法则在特定条件刺激下可能发生的连锁反应或次级变异'),
              锚点感应: lockedStr("对'现实锚点'发出的稳定波动有微弱的感知能力，能在一定范围内大致判断出稳定区的方向"),
              能量亲和: lockedStr(
        ...
        .object({
          ...
          能力: z
            .object({
              ...
              快速适应: lockedStr('心智对法则悖论有极强的韧性，不易因现实扭曲而陷入疯狂或认知失调'),
              战斗直觉: lockedStr('即使不完全理解法则的原理，也能通过战斗本能找到最优的行动方案'),
            })
            .catchall(z.string())
            .prefault({}),
    ...
    .object({
      Lily: z
        .object({
          ...
          身份: uniqueStrArrayWith(['白巫女'], ['白巫女']),
          好感度: clampedNum(0.1, -1, 1),
          污秽侵蚀度: clampedNum(0.1, 0, 1),
          当前状态: uniqueStrArray(),
          外观: z
            .object({
              外貌: appearance(),
        ...
        .object({
          ...
          能力: z
            .object({
              ...
              气味占卜: lockedStr('一种基于超常嗅觉的特殊能力，是翠的独特感知方式'),
              法则适应性: lockedStr("与所有'受诅之子'一样，拥有对'强加法则'的本能适应力"),
            })
            .catchall(z.string())
            .prefault({}),
        })
        ...
        .object({
          ...
          能力: z
            .object({
              ...
              '双刀/四刀流剑术': lockedStr('精通使用小太刀进行战斗，刀法凌厉致命，是纯粹为了杀戮而磨练出的技艺'),
              法则适应性: lockedStr("与所有'受诅之子'一样，拥有对'强加法则'的本能适应力"),
            })
            .catchall(z.string())
            .prefault({}),
  ...
  次要角色: z
    ...
    .transform(obj => {
      // 使用 lodash pickBy 过滤掉不允许的次要角色
      const allowedKeys = _.keys(obj).filter(key => SecondaryCharEnum.safeParse(key).success);
